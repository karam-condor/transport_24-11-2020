...
namespace transport
{
	public static class RandomProvider
	{
		...
		public static Pedido[] GetRandomDestinations(int count)
		{
			if (count < 2)
		...
		public static Pedido[] GetGeocodedDestinations(Pedido[] locations)
		{
		...
		public static void MutateRandomLocations(Pedido[] locations)
		{
			if (locations == null)
			...
			int mutationCount = GetRandomValue(locations.Length / 20) + 1;
			for (int mutationIndex = 0; mutationIndex < mutationCount; mutationIndex++)
			{
				...
				{
					case 0: Pedido.SwapLocations(locations, index1, index2); break;
					case 1: Pedido.MoveLocations(locations, index1, index2); break;
					case 2: Pedido.ReverseRange(locations, index1, index2); break;
					default: throw new InvalidOperationException();
				}
			}
		}

		public static void FullyRandomizeLocations(Pedido[] locations)
		{
			if (locations == null)
				throw new ArgumentNullException("locations");
			...
			for (int i = count - 1; i > 0; i--)
			{
				...
				if (value != i)
					Pedido.SwapLocations(locations, i, value);
			}
		}

		internal static void _CrossOver(Pedido[] locations1, Pedido[] locations2, bool mutateFailedCrossovers)
		{
			...
			var availableLocations = new HashSet<Pedido>(locations1);
